...
const forms: FormItem[] = [
  {
    ...
    description: 'Apply for open positions at Yeti Hydropower. Complete application with employment history and references.',
    category: 'HR',
    fileUrl: '/files/job-application.pdf',
    fileSize: '245 KB',
  ...
  },
  {
    ...
    description: 'Register as a supplier or contractor with detailed company information and certifications.',
    category: 'Procurement',
    fileUrl: '/files/vendor-registration.pdf',
    fileSize: '198 KB',
  ...
  },
  {
    ...
    description: 'Submit employee leave requests including vacation, sick leave, and personal time off.',
    category: 'HR',
    fileUrl: '/files/leave-request.pdf',
    fileSize: '156 KB',
  ...
  },
  {
    ...
    description: 'Request reimbursement for business expenses with receipt attachments.',
    category: 'Finance',
    fileUrl: '/files/expense-form.pdf',
    fileSize: '203 KB',
  ...
  },
  {
    ...
    description: 'Report workplace safety incidents and near-miss events for investigation.',
    category: 'Safety',
    fileUrl: '/files/incident-report.pdf',
    fileSize: '267 KB',
  ...
  },
  {
    ...
    description: 'Request maintenance or repairs for company equipment and machinery.',
    category: 'Operations',
